...
use App\Mail\ConsultationRejection;
use App\Mail\ConsultationValidation;
...
class ConsultationController extends VoyagerBaseController{
    ...
    public function update(Request $request, $id)
    {
        ...
        $demande_statut = DB::table('consultations')->where('id',$id)->get()->first()->statut;
        $reservation_date = DB::table('consultations')->where('id',$id)->get()->first()->created_at;
        ...
        $user_name = $user->name;
        if($demande_statut !== $updated_value){
            if($updated_value == "refused"){
                Mail::to($user_email)->send(new ConsultationRejection($user_name,$reservation_date));
            }else if($updated_value == "Validated"){
                Mail::to($user_email)->send(new ConsultationValidation($user_name,$reservation_date));
            }
        }
