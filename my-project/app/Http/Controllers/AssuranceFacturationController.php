...
class AssuranceFacturationController extends VoyagerBaseController
{
    ...
    private function createRemboursement(Assurancefacturation $facture)
    {
        ...
        $remboursement->created_at = date("Y-m-d h:i:s");
    ...
    private function updateRemboursement($data){
        $facturation = Assurancefacturation::where('numerofacture',$data->get('numerofacture'))->get()->first();
        $remboursement = Remboursementassurance::where('facture',$facturation->id)->get()->first();
        $remboursement->montant = $data->get('montant');
        $remboursement->demandeur = $data->get('user');
        $remboursement->assurance = $data->get('assurance');
    ...
    public function destroy(Request $request, $id)
    {
        ...
        foreach ($ids as $id) {
         ...
         DB::table('remboursementassurances')->where('facture',$id)->delete();
