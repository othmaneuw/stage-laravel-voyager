...
class LoisirFacturation extends VoyagerBaseController
{
    ...
    private function updateRemboursement($data){
        $facturation = Loisirsfacturation::where('numerofacture',$data->get('numerofacture'))->get()->first();
        $remboursement = Loisirsremboursement::where('facture',$facturation->id)->get()->first();
        $remboursement->montant = $data->get('montant');
        $remboursement->demandeur = $data->get('user');
        $remboursement->activite = $data->get('activite');
    ...
    public function destroy(Request $request, $id)
    {
        ...
        foreach ($ids as $id) {
         ...
         DB::table('loisirsremboursements')->where('facture',$id)->delete();
