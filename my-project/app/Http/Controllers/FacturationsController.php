...
class FacturationsController extends VoyagerBaseController
{
    ...
    private function updateRemboursement($data){
        $facturation = Facturation::where('numerofacture',$data->get('numerofacture'))->get()->first();
        $remboursement = Remboursementprisesencharge::where('facture',$facturation->id)->get()->first();
