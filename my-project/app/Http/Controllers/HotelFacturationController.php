...
use App\Models\Hotelfacturation as ModelsHotelfacturation;
use App\Models\Hotelremboursement;
...
class HotelFacturationController extends VoyagerBaseController
{
    ...
    private function createRemboursement(ModelsHotelfacturation $facture)
    {
        $id = $facture->id;
        ...
        $user = $facture->user;
        $remboursement = new Hotelremboursement();
    ...
    private function updateRemboursement($data){
        $facturation = ModelsHotelfacturation::where('numerofacture',$data->get('numerofacture'))->get()->first();
        $remboursement = Hotelremboursement::where('facture',$facturation->id)->get()->first();
    ...
    public function destroy(Request $request, $id)
    {
        ...
        foreach ($ids as $id) {
         ...
         DB::table('hotelremboursements')->where('facture',$id)->delete();
