...
class PriseEnCharges extends BaseDimmer
{
    ...
    public function run()
    {
        if (Auth::user()['role_id'] == Role::where('name', 'admin')->get()->first()->id || Auth::user()['role_id'] == Role::where('name', 'Admin AOS')->get()->first()->id || Auth::user()['role_id'] == Role::where('name', 'Gestionnaire AOS')->get()->first()->id || Auth::user()['role_id'] == Role::where('name', 'Gestionnaire Prise en charges')->get()->first()->id) {
