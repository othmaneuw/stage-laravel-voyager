...
@section('page_header')
    <div class="container-fluid">
        ...
        <div style="display: flex;gap:5px;">
            ...
            <button id="btn-filter" style="border: none;background-color:dodgerBlue;color:white;font-weight:bold"> Filtrer
            </button>
        </div>
        <script>
            ...
            btn.addEventListener('click', function handleClick(event) {
                ...
                window.location.replace(`http://localhost:8000/admin/souscriptionassurances?selected=${selectElement.value}`);
            })
        </script>
